...
import { getUserSesison } from '@/lib/auth'

const links = [
    { href: '/track', label: 'Crawl' }
]
...
const Navbar = async ({ }) => {
    const user = await getUserSesison()
    return (
        <div className="fixed top-0 inset-x-0 h-fit bg-gray-100 border-b border-slate-gray z-[10] py-2">
